    ...
    <div className="flex flex-col lg:flex-row p-5 gap-5">
      <aside className="content-cover lg:w-80 border-b lg:border-r border-gray-300 pr-5">
        ...
        <button
          ...
          disabled={loading}
          className="w-full p-4 font-bold text-xl border-4 bg-linear-to-r hover:scale-105 from-green-500 to-green-600 border-green-900 text-white active:from-white active:to-white active:text-green-900 mt-5 mb-5 rounded-sm"
        >
